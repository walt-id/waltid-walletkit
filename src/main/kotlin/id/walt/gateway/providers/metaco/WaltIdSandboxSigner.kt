...
//    private val signServiceUrl = "sign-service-url"
//
...
//            setBody(mapOf("payload" to p1, "privateKey" to ProviderConfig.privateKey))
...
//    }
//
//    override fun getPublicKey(): String = ProviderConfig.publicKey
//
//    override fun getAuthor() = Author(ProviderConfig.userId, ProviderConfig.domainId)
//
//    @Serializable
